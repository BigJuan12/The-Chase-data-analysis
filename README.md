...
This project investigates whether **momentum exists in the Final Chase**.

Specifically, it tests whether the probability of answering a question correctly depends on the outcome of the previous question.
